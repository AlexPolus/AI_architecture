...
from sklearn.metrics import accuracy_score, precision_score, recall_score, f1_score # критерий качества, точность accuracy, precision_score, recall_score, f1_score (confusion_matrix)
...
def create_new_dataset():
    ...
    df.to_csv('C:/Users/Александр/PycharmProjects/pythonProject/ml_boost/student.csv', index=False)

def preprocess_dataset(
            file='C:/Users/Александр/PycharmProjects/pythonProject/ml_boost/student.csv',
    ...
    if (need_to_encode_y):
        ...
        new_result.to_csv('C:/Users/Александр/PycharmProjects/pythonProject/ml_boost/result_labels.csv', index=False)
        y = temp
        print(y)
